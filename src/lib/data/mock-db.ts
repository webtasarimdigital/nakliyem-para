...
// Seed Requests — Platform canlıya çıktığında gerçek müşteri talepleriyle dolacak
export const SEED_REQUESTS: MovingRequest[] = [];

// Seed Offers — Platform canlıya çıktığında gerçek nakliyeci teklifleriyle dolacak
