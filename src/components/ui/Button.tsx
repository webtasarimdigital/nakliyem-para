...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    ...
    navy: 'bg-[#1E3A8A] text-white hover:bg-[#1E40AF] focus:ring-[#1E3A8A] shadow-md shadow-blue-900/25',
    outline: 'border-2 border-slate-300 bg-white text-[#0A1128] hover:border-[#F95700]/60 hover:bg-orange-50/40 focus:ring-[#F95700]',
    ...
    ghost: 'bg-transparent text-slate-600 hover:bg-slate-100 hover:text-[#0A1128]',
