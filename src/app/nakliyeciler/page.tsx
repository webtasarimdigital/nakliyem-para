    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-16 bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-2xl mx-auto mb-14">
            <h2 className="text-2xl sm:text-3xl font-bold text-[#111E38] mb-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200">
              ...
              <h3 className="text-base font-bold text-[#111E38] mb-2">Günlük Taşıma İşleri</h3>
            ...
            <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200">
              ...
              <h3 className="text-base font-bold text-[#111E38] mb-2">Nakliyeci Defteri</h3>
              <p className="text-xs text-slate-600 leading-relaxed">
            ...
            <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200">
              ...
              <h3 className="text-base font-bold text-[#111E38] mb-2">Rota Alarmları</h3>
              <p className="text-xs text-slate-600 leading-relaxed">
            ...
            <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200">
              ...
              <h3 className="text-base font-bold text-[#111E38] mb-2">Dijital Reklam Desteği</h3>
              <p className="text-xs text-slate-600 leading-relaxed">
      ...
      <section className="py-16 bg-[#EAF3FF] text-center">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <h2 className="text-2xl sm:text-3xl font-black text-[#111E38] mb-3">
