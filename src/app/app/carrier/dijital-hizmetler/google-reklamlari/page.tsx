...
const PACKAGES = [
  {
    ...
    "desc": "Düşük bütçeyle anında çağrı almak için",
    "price": "750 TL",
    "period": "/ ay (yönetim)",
    "isFeatured": false,
    "features": [
      "Google Ads Hesap Kurulumu",
      "1 Şehir / 10 Arama Grubu",
      "Negatif Kelime Engellemesi (Gereksiz Tıklama Yok)",
      "WhatsApp Teklif Dönüşüm Takibi"
    ]
  },
  {
    "name": "Profesyonel Ads",
    "desc": "Haftanın her günü düzenli taşıma bağlayan firmalar",
    "price": "1.500 TL",
    "period": "/ ay (yönetim)",
    "isFeatured": true,
    "features": [
      "Gelişmiş Tıklama Başı Maliyet Düşürme",
      "Şehirlerarası Rota Hedeflemesi",
      "A/B Reklam Metin Testleri",
      "Haftalık Performans İyileştirmesi",
      "Bütçe İsrafını Önleme Garantisi"
    ]
  },
  {
    "name": "Filo & VIP Ads",
    "desc": "Yüksek bütçeli büyük taşımacılık filoları",
    "price": "2.500 TL",
    "period": "/ ay (yönetim)",
    "isFeatured": false,
    "features": [
      "Sınırsız Güzergah ve Kampanya",
      "Yapay Zeka Destekli Teklif Stratejisi",
      "Özel Hesap Yöneticisi",
      "Anlık Çağrı Kaydı Takibi"
    ]
  }
];
const FEATURES = [
  {
    "title": "Aynı Gün Çağrı Başlar",
    "desc": "Reklamınız onaylandığı andan itibaren telefonunuz çalmaya başlar."
  },
  {
    "title": "Bütçeniz Boşa Gitmez",
    "desc": "Nakliyat aramayan kişilerin tıklamaları negatif kelimelerle %100 engellenir."
  },
  {
    "title": "Şehir ve Saat Hedefleme",
    "desc": "Yalnızca hizmet verdiğiniz şehirlerde ve çalışma saatlerinizde reklam gösterilir."
  },
  {
    "title": "Şeffaf Bütçe Kontrolü",
    "desc": "Reklam bütçenizi doğrudan Google\\'a ödersiniz, gizli ek kesinti olmaz."
  }
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="mb-8">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-50 text-[#F95700] border border-orange-200 text-xs font-bold mb-2">
            ...
            <span>Anında Taşınma Talepleri</span>
          </div>
          ...
          <p className="text-xs sm:text-sm text-slate-500 font-medium mt-1 max-w-3xl leading-relaxed">
            Taşınmak isteyen müşteriler arama yaptığı anda firmanız en tepede çıksın. Bütçenizi verimli yöneterek en doğru müşterilere ulaştırıyoruz.
          </p>
        </div>
