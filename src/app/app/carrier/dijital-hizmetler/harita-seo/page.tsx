...
const PACKAGES = [
  {
    ...
    "desc": "Google Haritalar kaydı olmayanlar için",
    "price": "1.200 TL",
    "period": "tek seferlik",
    "isFeatured": false,
    "features": [
      "Google Business Profil Açılışı",
      "Pin Konumu Doğrulama",
      "Kategori & Hizmet Alanları Tanımı",
      "Logo & Araç Fotoğraf Yüklemesi"
    ]
  },
  {
    "name": "Harita Sıralama Yükseltme",
    "desc": "Haritalarda ilk 3 sıra hedefleyenler",
    "price": "2.200 TL",
    "period": "tek seferlik",
    "isFeatured": true,
    "features": [
      "Yerel Harita SEO Optimizasyonu",
      "Yorum Şablonları & Yorum Toplama",
      "Harita Anahtar Kelime Uyarlaması",
      "Doğrudan Arama Çağrısı Artışı",
      "1 Ay Destek & Takip"
    ]
  },
  {
    "name": "Sürekli Harita Yönetimi",
    "desc": "Düzenli yorum & müşteri akışı",
    "price": "1.000 TL",
    "period": "/ aylık",
    "isFeatured": false,
    "features": [
      "Haftalık Gönderi & Fotoğraf Paylaşımı",
      "Olumsuz Yorum Kriz Yönetimi",
      "Rakip Spam Harita Şikayeti",
      "Aylık Çağrı & Yol Tarifi Raporu"
    ]
  }
];
const FEATURES = [
  {
    "title": "Telefonlar Doğrudan Çalar",
    "desc": "Müşteriler haritadan doğrudan 'Ara' butonuna basarak yetkilinizle iletişime geçer."
  },
  {
    "title": "Yakındaki Müşterileri Çeker",
    "desc": "Bulunduğunuz ilçede nakliyeci arayan herkese ilk sırada sizin logonuz görünür."
  },
  {
    "title": "Güven ve Yüksek Puan",
    "desc": "5 yıldızlı gerçek müşteri yorumları sayesinde teklif kapatma oranınız 3 katına çıkar."
  },
  {
    "title": "Hızlı Sonuç",
    "desc": "Harita optimizasyonu genellikle 7-14 gün içinde doğrudan çağrı artışı sağlar."
  }
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="mb-8">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-50 text-[#F95700] border border-orange-200 text-xs font-bold mb-2">
            ...
            <span>Yerel Müşterilerde 1. Sıra</span>
          </div>
          <h1 className="text-2xl sm:text-4xl font-black text-[#0A1128] tracking-tight">
            Harita SEO (Google Maps)
          </h1>
          <p className="text-xs sm:text-sm text-slate-500 font-medium mt-1 max-w-3xl leading-relaxed">
            Google Haritalar işletme profilinizi doğrulayıp optimize ediyoruz. Yakınınızda nakliyeci arayan müşterilerin doğrudan sizi aramasını sağlıyoruz.
          </p>
        </div>
