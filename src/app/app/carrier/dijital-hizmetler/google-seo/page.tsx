...
const PACKAGES = [
  {
    ...
    "desc": "Bulunduğunuz ildeki aramalar için",
    "price": "1.500 TL",
    "period": "/ aylık",
    "isFeatured": false,
    "features": [
      "1 İl & 10 Anahtar Kelime",
      "Sayfa İçi SEO Düzenlemesi",
  ...
  },
  {
    ...
    "desc": "Komşu iller ve yoğun güzergahlar",
    "price": "2.500 TL",
    "period": "/ aylık",
    "isFeatured": true,
    "features": [
      "25 Anahtar Kelime Takibi",
      "Şehirlerarası Rota Sayfaları",
  ...
  {
    "name": "Türkiye Geneli SEO",
    "desc": "81 ilde lider nakliyat markaları için",
    "price": "4.500 TL",
    "period": "/ aylık",
    "isFeatured": false,
    "features": [
      "50+ Anahtar Kelime",
      "Tüm Türkiye İlçe Odaklı SEO",
      "Blog & Makale Üretimi",
      "7/24 SEO Danışmanı"
    ]
  }
...
const FEATURES = [
  {
    "title": "Organik ve Ücretsiz Müşteri",
    "desc": "Reklama tıklama başı para ödemeden, doğal aramalardan sürekli ücretsiz telefon çağrıları alın."
  },
  {
    "title": "Bölgesel Şehir Aramaları",
    "desc": "'İstanbul evden eve nakliyat', 'Ankara nakliye firmaları' gibi tam hedef aramalarda yükselin."
  },
  {
    "title": "Şeffaf Aylık Raporlama",
    "desc": "Hangi kelimede kaçıncı sıraya çıktığınızı her ay grafiklerle net olarak görün."
  },
  {
    "title": "Kalıcı Sonuçlar",
    "desc": "SEO çalışması yapıldıkça sitenizin otoritesi artar ve uzun yıllar üst sıralarda kalırsınız."
  }
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="mb-8">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-50 text-[#F95700] border border-orange-200 text-xs font-bold mb-2">
            ...
            <span>Google 1. Sayfa Garantisi</span>
          </div>
          ...
          <p className="text-xs sm:text-sm text-slate-500 font-medium mt-1 max-w-3xl leading-relaxed">
            Google aramalarında firmanızı üst sıralara taşıyarak komisyonsuz doğrudan müşteri kazandırıyoruz.
          </p>
        </div>
