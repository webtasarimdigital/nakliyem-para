...
const PACKAGES = [
  {
    "name": "Instagram Başlangıç",
    "desc": "Instagram ve Facebook varlığı oluşturma",
    "price": "1.800 TL",
    "period": "/ aylık",
    "isFeatured": false,
    "features": [
      "Haftalık 3 Özel Görsel Paylaşımı",
      "Taşınma İpuçları & Güven Gönderileri",
      "Profil & Bio Tasarımı",
      "Temel Hedef Kitle Reklamı"
    ]
  },
  {
    "name": "Aktif Müşteri Kampanyası",
    "desc": "Sosyal medyadan doğrudan teklif toplama",
    "price": "3.200 TL",
    "period": "/ aylık",
    "isFeatured": true,
    "features": [
      "Haftalık 5 Profesyonel Gönderi & Reels",
      "Ev Kiralayan / Satanlara Hedefli Reklam",
      "WhatsApp Lead Reklamı Yönetimi",
      "Müşteri Mesaj Şablonları",
      "Aylık Büyüme & Dönüşüm Raporu"
    ]
  },
  {
    "name": "Full Ajans Marka Paketi",
    "desc": "Bölgenin en tanınan nakliyat markası olun",
    "price": "5.500 TL",
    "period": "/ aylık",
    "isFeatured": false,
    "features": [
      "Reels Video Prodüksiyon Desteği",
      "TikTok, Instagram, Facebook, YouTube",
      "Influencer / Bölgesel İş Birlikleri",
      "7/24 Hesap ve Yorum Yönetimi"
    ]
  }
];
const FEATURES = [
  {
    "title": "Görsel Güven Yaratır",
    "desc": "Temiz ambalajlama ve profesyonel araç fotoğrafları müşteriyi doğrudan ikna eder."
  },
  {
    "title": "Doğru Zamanda Hedefleme",
    "desc": "Yeni ev kiralayan veya evlilik aşamasındaki kişilere tam ihtiyaç anında ulaşın."
  },
  {
    "title": "Rakiplerden Ayrışın",
    "desc": "Kurumsal sosyal medya profili olan firmalar %40 daha yüksek fiyata iş bağlayabilir."
  },
  {
    "title": "Tasarım Zahmeti Yok",
    "desc": "Tüm gönderi ve videolar grafik ekibimiz tarafından firmanızın logosuyla hazırlanır."
  }
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="mb-8">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-50 text-[#F95700] border border-orange-200 text-xs font-bold mb-2">
            ...
            <span>Meta (Instagram & FB) Büyüme</span>
          </div>
          ...
          <p className="text-xs sm:text-sm text-slate-500 font-medium mt-1 max-w-3xl leading-relaxed">
            Ev taşıma döneminde olan kullanıcılara özel hedefli video ve görsel reklamlarla marka bilinirliği ve müşteri toplayın.
          </p>
        </div>
