...
export default function BlogDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10">
      <Link href="/blog" className="inline-flex items-center gap-1.5 text-xs font-bold text-slate-500 hover:text-[#111E38] mb-6">
      ...
      <div className="bg-white rounded-3xl border border-slate-200 p-6 sm:p-10 shadow-xs space-y-8">
        <div>
          ...
          <h1 className="text-2xl sm:text-4xl font-black text-[#111E38] leading-tight">
        ...
        <div className="space-y-4 text-xs sm:text-sm text-slate-700 leading-relaxed">
          ...
          <h2 className="text-lg font-bold text-[#111E38] pt-2">1. Eşya Hacmi ve Oda Sayısı</h2>
          <p>
          ...
          <h2 className="text-lg font-bold text-[#111E38] pt-2">2. Kat Yükseklikleri ve Asansör Durumu</h2>
          <p>
          ...
          <h2 className="text-lg font-bold text-[#111E38] pt-2">3. Mesafe ve Yakıt Giderleri</h2>
          <p>
        ...
        <div className="p-6 rounded-2xl bg-[#EAF3FF] border border-blue-200 text-center space-y-3">
          <h3 className="text-base font-bold text-[#111E38]">Eviniz İçin Net Fiyat Öğrenmek İster misiniz?</h3>
