  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
      <div className="bg-white rounded-3xl border border-slate-200 p-8 sm:p-12 shadow-xs space-y-6 text-xs sm:text-sm text-slate-700 leading-relaxed">
        ...
        <h2 className="text-base font-bold text-slate-900 pt-2">1. Hizmetin Kapsamı</h2>
        <p>
        ...
        <h2 className="text-base font-bold text-slate-900 pt-2">2. Ücretsiz Teklif Alma</h2>
        <p>
          Müşteriler için talep oluşturmak, firmalarla yazışmak ve teklif almak tamamen ücretsizdir.
        </p>

        <h2 className="text-base font-bold text-slate-900 pt-2">3. Nakliyeci Sorumlulukları</h2>
        <p>
